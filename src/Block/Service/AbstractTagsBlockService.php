...
abstract class AbstractTagsBlockService extends AbstractClassificationBlockService
{
     ...
     * @param AdminInterface|null
     */
    public function __construct($twigOrDeprecatedName, $contextManagerOrDeprecatedTemplating, $tagManagerOrDeprecatedContextManager, $tagAdminOrDeprecatedTagManager, $deprecatedTagAdmin)
    {
